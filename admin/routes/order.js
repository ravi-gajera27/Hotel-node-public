...
router.get("/:table_no/:order_id/:cid", protect, order.getOrderByOrderId);
router.put(
...
router.get("/:table_no/:order_id/:cid/:type", protect, order.getOrderByOrderId);
router.put(
  "/set-order/:table_no/:order_id/:cid/:type",
  protect,
  order.setOrderByOrderId
);

router.post("/add-order-cust/:table_no/:cid", protect, order.addOrderByTableNo);
...
router.post(
  "/add-order-cust/:table_no/:cid/:type",
  protect,
  order.addOrderByTableNo
);
router.post("/:table_no/:type", protect, order.addOrderByTableNo);
router.get("/:table_no/:type", protect, order.getOrderByTableNo);
router.put("/:table_no/;type", protect, order.setOrderByTableNo);
